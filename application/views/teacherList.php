...
<div class="container">
    ...
    <div class="myCharts">
        <canvas id="TeacherChart" width="80" height="80" style="border:1px solid #000000;">
...
<script>
                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        ...
                        if (data[i].subject === 'History') {
                            ...
                            m++;
                        } else if (data[i].subject === 'Science') {
                            s++;
                        } else {
                            other++;
                        }
                    ...
                    TeacherChart.data.datasets[0].data = [h, m, s, other];
                    TeacherChart.update();
                },
                error: function() {
    ...
    const labels = ['History', 'Mathematic', 'Science', 'Others'];
    const data = {
        labels: labels,
        datasets: [{
            data: [
